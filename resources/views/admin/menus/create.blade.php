          ...
          <div class="x_content">
             <div class="row">
                <form method="POST" action="/administrator/menus" class="form-horizontal form-label-left">
				  ...
				  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="menu_url">Menu Type</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="menu_url">Url</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
